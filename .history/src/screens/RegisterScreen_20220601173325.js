...
export const RegisterScreen = ({navigation, route}) => {
  ...
  const registerPrivateFun = async () => {
    const localMsg = !fullName ? "Please enter full name" : !email ? "Please enter email" : !city ? "Please enter city" : !password ? "Please enter password" : !cPassword ? "Please enter confirm password" : 
